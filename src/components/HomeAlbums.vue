  ...
  data() {
    return {
      ...
      albums:[
        ...
        {img:Echoes, dissapear:'no', all:'yes', vinyl:'yes', studio:'no', mixtape:'yes', compilation:'no', EP:'no', name:'Echoes Of Silence', menu:false, hideMenu:true, released:'2011', tracklist:['1.Real Life', '2.Losers','3.Tell Your Friend','4.Often','5.The Hills', '6.Acquainted', "7.Can't Feel My Face", '8.Earned It', '9.In the Night', '10.As You Are', '11.Dark Times', '12.Prisoner', '13.Angel']},
        {img:Thursday, dissapear:'no', all:'yes', vinyl:'yes', studio:'no', mixtape:'yes', compilation:'no', EP:'no', name:'Thursday', menu:false, hideMenu:true, released:'2011', tracklist:['1.Real Life', '2.Losers','3.Tell Your Friend','4.Often','5.The Hills', '6.Acquainted', "7.Can't Feel My Face", '8.Earned It', '9.In the Night', '10.As You Are', '11.Dark Times', '12.Prisoner', '13.Angel']},
        {img:HOB, dissapear:'no', all:'yes', vinyl:'no', studio:'no', mixtape:'yes', compilation:'no', EP:'no', name:'House Of Balloons', menu:false, hideMenu:true, released:'2011', tracklist:['1.Call Out My Name', '2.Try Me', '3.Wasted Times', '4.I Was Never There', '5.Hurt You', 'Privilege']},
        {img:StarboyVinyl, dissapear:'no', all:'yes', vinyl:'yes', studio:'yes', mixtape:'no', compilation:'no', EP:'no', name:'Starboy', menu:false, hideMenu:true, released:'2016', tracklist:['1.Starboy','2.Party Monster', '3.False Alarm', '4.Reminder', '5.Rockin', '6.Secrets', '7.True Colors', '8.Stargirl Interlude', '9.Sidewalks', '10.Six Feet Under', '11.Love To Lay', '12.Lonely Night', '13.Attention','14.Ordinary Life', '15.Nothing Without You']},
        {img:Trilogy, dissapear:'no', all:'yes', vinyl:'yes', studio:'no', mixtape:'no', compilation:'yes', EP:'no', name:'Trilogy', menu:false, hideMenu:true, released:'2011', tracklist:['1.Real Life', '2.Losers','3.Tell Your Friend','4.Often','5.The Hills', '6.Acquainted', "7.Can't Feel My Face", '8.Earned It', '9.In the Night', '10.As You Are', '11.Dark Times', '12.Prisoner', '13.Angel']},
